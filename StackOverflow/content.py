...
class Post(Content):
    ...
    def notify_obervers(self, event: 'Event'):
        for observer in self.observeers:
    ...
    def vote(self, user: User, vote_type: VoteType):
        with self._lock:
            ...
            if isinstance(self, Question):
                ...
                event_type = EventType.UPVOTE_ANSWER if vote_type == VoteType.UPVOTE else EventType.DOWNVOTEZ_ANSWER
